...
const OpenConversation = () => {
	...
	function handlerChange (e) {
		...
		if(e.target.value === '') submitRef.current.classList.add('btn-disabled')

		else submitRef.current.classList.remove('btn-disabled')
	...
	return (
		...
		<>
			...
			<header className="chat-header" onClick={toProfile}>

				<div className="contact-img-small">
				...
				<div>
					...
					<p className="user-typing fs--3 none" ref={typingRef}>Escribiendo...</p>
			...
			<section className="chat">
				...
				<div className="messages" ref={msgConRef}>
				...
				<form className="form-message" onSubmit={handlerSubmit}>
					
					<input className="write-area" type="text" ref={textRef} onChange={handlerChange} onKeyUp={isTyping}/>
				
					<input className="none" id="input-submit" type="submit"/>
						
					<label className="btn-send-message btn-disabled" ref={submitRef} htmlFor="input-submit"><i className="text-white bi-send-fill"></i></label>	
